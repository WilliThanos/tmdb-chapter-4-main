...
const ITEMS_PER_PAGE = 6; // Ubah sesuai kebutuhan Anda
...
const SearchWilli = () => {
  ...
  }, [query, currentPage, selectLanguage, selectYear, selectRegion]);

  const searchMovies = async () => {
    try {
      const response = await axios.get(
        `https://api.themoviedb.org/3/search/movie?query=${query}&api_key=${API_KEY}&include_adult=false&language=${selectLanguage}&page=${currentPage}&year=${selectYear}&region=${selectRegion}`,
